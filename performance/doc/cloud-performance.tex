...
\author{\IEEEauthorblockN{Adam Cattermole}
  \IEEEauthorblockA{School of Computing Science\\Newcastle University, UK\\
...
\begin{figure}[ht]
  \centering
  \includegraphics[width=\linewidth]{thread_pool.png}
...
\begin{figure}[ht]
  \centering
  \includegraphics[width=\linewidth]{azure_variability.png}
...
\begin{figure}[ht]
  \centering
  \includegraphics[width=\linewidth]{ec2_variability.png}
...
\begin{figure}[ht]
  \centering
  \includegraphics[width=\linewidth]{bothchart.png}
...
\begin{figure}[ht]
  \centering
  \includegraphics[width=\linewidth]{thread_variability.png}
